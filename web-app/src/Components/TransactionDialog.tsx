...
import { Dialog, DialogActions, DialogContent, DialogTitle, Button, IconButton, TextField, MenuItem, Box, List, ListItem, ListItemText } from '@mui/material';
...
const TransactionDialog: React.FC<TransactionDialogProps> = ({
    ...
    const selectedUser = users.find(user => user.id === newTransaction.receiver_id);
