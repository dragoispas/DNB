...
import { resetNewTransaction, updateNewTransactionField } from '../store/transactions';

export const useTransaction = () => {
    const dispatch = useDispatch();
    const newTransaction = useSelector((state: RootState) => state.transactions.transactionToSubmit);
