...
const transactionSlice = createSlice({
    ...
    reducers: {
        ...
        updateNewTransactionField: (state, action: PayloadAction<{ field: string, value: any }>) => {
...
export const { setTransactions, setPage, setTotalPages, setTotalItems, setItemsPerPage, setNewTransaction, resetNewTransaction, updateNewTransactionField } = transactionSlice.actions;
